CREATE TABLE tbl_item_file_balance_match
  (
    ...
    FOREIGN KEY(master_ifb_id) REFERENCES tbl_item_file_balance(ifb_id) ON DELETE CASCADE,
    FOREIGN KEY(depend_ifb_id) REFERENCES tbl_item_file_balance(ifb_id) ON DELETE CASCADE
  );
