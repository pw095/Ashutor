CREATE TABLE tbl_item_file_balance
  (
    ...
    ifb_number        REAL                              NOT NULL,
    ifb_subtotal_flag TEXT                              NOT NULL,
    FOREIGN KEY(ifb_file_id)      REFERENCES tbl_file(file_id),
    FOREIGN KEY(ifb_item_id)      REFERENCES tbl_item(item_id),
    FOREIGN KEY(ifb_fine_item_id) REFERENCES tbl_fine_item(fine_item_id)
  );
